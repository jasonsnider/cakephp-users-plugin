...
class UserFixture extends CakeTestFixture {
    ...
    public $fields = array(
        ...
        'root' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => 'Set to 1 if the user has root level access'),
        'employee' => array('type' => 'boolean', 'null' => false, 'default' => '0', 'comment' => 'Set to 1 if the user has employee level access'),
